...
1.1. **Администрация:** Владельцы сервера и уполномоченные лица.
1.2. **Пользователь:** Любое лицо, осуществившее вход на Сервер.
1.3. **Контент:** Плагины, код, генерация мира и постройки на Сервере.

### 2. АКЦЕПТ (СОГЛАСИЕ)
2.1. Вход на Сервер является автоматическим согласием с данной офертой.
2.2. Если вы не согласны, вы должны немедленно покинуть проект.
...
1.1. **Administration:** Server owners and authorized staff.
1.2. **User:** Any individual connecting to the Server.
1.3. **Content:** Plugins, code, world generation, and assets on the Server.

### 2. ACCEPTANCE
2.1. Joining the Server constitutes automatic acceptance of this agreement.
2.2. If you disagree with these terms, you must leave the Server immediately.
...
<div align="center">
    ...
    <br>
    <br>
    <p><i>С уважением, команда RustZone | Best regards, RustZone Team</i></p>
</div>